...
class Carlos {
  ...
  List<dynamic> errors;
  int results;
  List<Response5> response;

  factory Carlos.fromJson(String str) => Carlos.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory Carlos.fromMap(Map<String, dynamic> json) => Carlos(
    welcomeGet: json["get"],
    parameters: Parameters.fromMap(json["parameters"]),
    errors: List<dynamic>.from(json["errors"].map((x) => x)),
    results: json["results"],
    response: List<Response5>.from(json["response"].map((x) => Response5.fromMap(x))),
  );
...
class Response5 {
  ...
  factory Response5.fromJson(String str) => Response5.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory Response5.fromMap(Map<String, dynamic> json) => Response5(
    id: json["id"],
    name: json["name"],
    abbr: json["abbr"],
    image: json["image"],
