...
class Formula1 {
  ...
  factory Formula1.fromJson(String str) => Formula1.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory Formula1.fromMap(Map<String, dynamic> json) => Formula1(
    formula1Get: json["get"],
...
class TeamTeam {
  ...
  Map<String, dynamic> toMap() => {
    "id": id,
    "name": nameValues.map[name],
    "logo": logo,
  };
}

enum Name { MERCEDES_AMG_PETRONAS, MC_LAREN_RACING }

final nameValues = EnumValues({
  "McLaren Racing": Name.MC_LAREN_RACING,
  "Mercedes-AMG Petronas": Name.MERCEDES_AMG_PETRONAS
});
