...
class Mick {
  ...
  List<dynamic> errors;
  int results;
  List<Response4> response;

  factory Mick.fromJson(String str) => Mick.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory Mick.fromMap(Map<String, dynamic> json) => Mick(
    welcomeGet: json["get"],
    parameters: Parameters.fromMap(json["parameters"]),
    errors: List<dynamic>.from(json["errors"].map((x) => x)),
    results: json["results"],
    response: List<Response4>.from(json["response"].map((x) => Response4.fromMap(x))),
  );
...
class Response4 {
  ...
  factory Response4.fromJson(String str) => Response4.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory Response4.fromMap(Map<String, dynamic> json) => Response4(
    id: json["id"],
    name: json["name"],
    abbr: json["abbr"],
    image: json["image"],
