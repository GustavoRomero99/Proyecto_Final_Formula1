...
class Welcome {
  ...
  factory Welcome.fromMap(Map<String, dynamic> json) => Welcome(
    ...
    response: List<Response2>.from(json["response"].map((x) => Response2.fromMap(x))),
  );
...
class Response2 {
  ...
  factory Response2.fromMap(Map<String, dynamic> json) => Response2(
    id: json["id"],
    name: json["name"],
    abbr: json["abbr"],
    image: json["image"],
    ...
    number: json["number"],
    grandsPrixEntered: json["grands_prix_entered"] == null ? null : json["grands_prix_entered"],
    ...
    highestGridPosition: json["highest_grid_position"] == null ? null : json["highest_grid_position"],
  ...
  Map<String, dynamic> toMap() => {
    ...
    "number": number,
    "grands_prix_entered": grandsPrixEntered == null ? null : grandsPrixEntered,
    "world_championships": worldChampionships,
    "podiums": podiums,
    "highest_race_finish": highestRaceFinish.toMap(),
    "highest_grid_position": highestGridPosition == null ? null : highestGridPosition,
